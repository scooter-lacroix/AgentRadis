"""
Enhanced DiagnosticInfo class with severity levels and error codes.
This replaces the existing implementation in app/agent/radis.py.
"""
...
# Standard error codes to ensure consistency
